...
#if 1	// !CRF!
#define DEBUG_COMMAND_MAX 4096	  // max size of command string sent to debugger
#endif
...
public: // Member Variables
  ...
  CSimpleArray<CSmtpAddress>     Recipients;       // Carbon Copy recipients
...
public: // Public functions
  ...
  int AddMultipleRecipientsFromString(String strRecipients);
